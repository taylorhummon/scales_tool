...
**key rank**: The number of sharps or flats in the key. Is positive when using sharps and 
...
**position**: A number that represents where a note is located on a dial or slider. Three is at the 
top, zero is at the center, and negative three is at the bottom. A note may have a position outside 
of the range [-3, 3], but it won't be displayed on the dial.
